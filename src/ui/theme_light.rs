...
pub fn update_env(env: &mut Env) {
    ...
    env.set(BACKGROUND_DARK, Color::rgb8(0xF0, 0xF0, 0xF0));
    ...
    // 影响switch 圆圈按钮的背景色
    env.set(FOREGROUND_DARK, Color::rgb8(0x80, 0x00, 0x80));
    env.set(FOREGROUND_LIGHT, Color::rgb8(0x80, 0x00, 0x80));

    // 按钮背景色：橙色 (#FFA500。渐变色
    env.set(BUTTON_DARK, Color::rgb8(0xff, 0xa5, 0x00));
    env.set(BUTTON_LIGHT, Color::rgb8(0xff, 0xa5, 0x00));
